...
pub const Reactor = struct {
    ...
    fn pushIndex(self: *Reactor, index: ConnectionId) void {
        self.free_indices[self.free_count] = index;
        self.free_count += 1;
    }

    fn popIndex(self: *Reactor) ConnectionId {
    ...
    fn removeClient(self: *Reactor, at: usize) void {
    ...
    fn drain_wakeup_fd(self: *Reactor) !void {
